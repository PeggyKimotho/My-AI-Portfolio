...
function Hero() {
  return (
    <section 
      id="home" 
      className="min-h-screen flex flex-col justify-center items-center px-4 pt-24 md:pt-32 pb-8 md:pb-16 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950"
    >
